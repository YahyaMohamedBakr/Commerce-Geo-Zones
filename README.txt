...
3. Go to the WooGeoZones settings page to configure your Google Sheets credentials and enable/disable features.
4. Enjoy the benefits of WooGeoZones on your WooCommerce store!

== Frequently Asked Questions ==
= How do I set up Google Sheets integration? =
1. Go to the WooGeoZones settings page in your WordPress admin panel.
...
== Changelog ==
= 1.0.0 =
* Initial release of WooGeoZones.
